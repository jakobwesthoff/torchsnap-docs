...
- [Permissions](/development/manifests/#permissions): host capabilities
...
<LinkCard title="Permissions" description="Host capabilities and the permission model" href="/development/manifests/#permissions" />
