...
- [Gadget manifest reference](/development/manifest/): all available fields
- [Search modes](/development/search-modes/): catalog, query, and prefix-routed
- [Permissions](/development/manifest/#permissions): host capabilities
...
<LinkCard title="Manifest Reference" description="All available fields in gadget.toml" href="/development/manifest/" />
<LinkCard title="Permissions" description="Host capabilities and the permission model" href="/development/manifest/#permissions" />
