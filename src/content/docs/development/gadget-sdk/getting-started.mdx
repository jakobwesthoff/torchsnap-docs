...
- [Gadget manifest reference](/development/gadget-sdk/manifest/) — all available fields
- [Search modes](/development/gadget-sdk/search-modes/) — catalog, query, and prefix-routed
- [Permissions](/development/gadget-sdk/permissions/) — host capabilities
...
<LinkCard title="Manifest Reference" description="All available fields in gadget.toml" href="/development/gadget-sdk/manifest/" />
<LinkCard title="Permissions Guide" description="Host capabilities and the permission model" href="/development/gadget-sdk/permissions/" />
